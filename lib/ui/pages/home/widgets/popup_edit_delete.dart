...
class PopupEditDelete extends StatefulWidget {
  ...
  const PopupEditDelete(this._onClick,
  ...
  @override
  _PopupEditDeleteState createState() => _PopupEditDeleteState();
}

class _PopupEditDeleteState extends State<PopupEditDelete> {
